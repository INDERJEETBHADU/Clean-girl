...
import foam_girl from "../assets/images/webp/clean-foam-girl.webp";
      ...
      <div className=" bg-lightpink relative  max-w-[1920px] mx-auto ">
        <div className="container max-w-[540px] md:max-w-[920px] lg:max-w-[992px] xl:max-w-[1200px] 2xl:max-w-[1164px]">
          ...
          <div className="row pt-[60px]">
            <div className="col-6">
              <img
                className=" max-w-[477.01px] w-full"
                src={foam_girl}
                alt="foam_girl"
              />
            </div>
            <div className="col-6">
              <div className="max-w-[558px] w-full p-[24px_24px_30px_24px] rounded-[16px]  bg-mediumpink ">
                ...
                {/* inside---boxes */}
                <div className="max-w-[510px] flex   justify-between items-center  w-full mt-4  rounded-[50px] bg-lightwhite py-[20px] px-[24px] ">
                ...
                <div className="max-w-[510px] border-[2px] border-[#053167] bg-[url(./assets/images/webp/ship_box_bg_layer.webp)] bg-cover bg-center bg-no-repeat flex   justify-between items-center  w-full mt-[16px]  rounded-[50px] bg-transparent py-[20px] px-[24px] ">
                ...
                <div className="max-w-[510px] flex   justify-between items-center  w-full mt-[16px]  rounded-[50px] bg-lightwhite py-[20px] px-[24px] ">
                  <h6 className=" font-Lexend  font-normal text-base leading-[20px] text-darkgrey ">
                    March 31
                  </h6>
                  <h6 className=" font-Lexend  font-normal text-base leading-[20px] text-darkgrey ">
