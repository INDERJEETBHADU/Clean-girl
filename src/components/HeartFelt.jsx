...
import slide_img_small from "../assets/images/webp/smallscreen_hertfelt_slide.webp"
  ...
  return (
    <>
      <div className="max-md:bg-lightpink max-w-[1920px] mx-auto">
        ...
        <Slider
          className="md:mt-[60px] mt-[40px] md:pb-[100px] lg:pb-[208px] relative"
          {...settings}
        >
          <div className="mx-[12px] flex justify-center">
            <div className="w-full hidden sm:block  max-w-[364px]">
              <img className="w-full " src={slide_img} alt="slide_img" />
            </div>
            <div className="w-full  sm:hidden  max-w-[100px]">
              <img className="w-full " src={slide_img_small} alt="slide_img" />
            </div>
          </div>
          <div className="mx-[12px] flex justify-center">
            <div className="w-full hidden sm:block  max-w-[364px]">
